	...
	L.TileLayer.Provider.providers = {
                ...
                Cloudmade: {
                        ...
                        options: {
                                ...
                                key: '185368fb3e5f4ee2ad2516ccc6577b28',
             			styleId: 22677,
	 	        	minZoom: 1,
                                name: 'Default',
                                noWrap: true
		...
		OpenStreetMap: {
			...
			variants: {
				...
				DE: {
					url: 'h//{s}.tile.openstreetmap.de/tiles/osmde/{z}/{x}/{y}.png'
				}
			}
		},
		OpenCycleMap: {
		...
		Stamen: {
			...
			variants: {
				...
				TonerHybrid: {
					url: '//stamen-tiles.a.ssl.fastly.net/toner-hybrid/{z}/{x}/{y}.png'
				},
				TonerLines: {
					url: '//stamen-tiles.a.ssl.fastly.net/toner-lines/{z}/{x}/{y}.png'
				},
				TonerLabels: {
					url: '//stamen-tiles.a.ssl.fastly.net/toner-labels/{z}/{x}/{y}.png'
				},
				TonerLite: {
				...
				Watercolor: {
					url: '//stamen-tiles.a.ssl.fastly.net/watercolor/{z}/{x}/{y}.jpg',
					options: {
                                                name: 'Watercolor',
						minZoom: 1,
						maxZoom: 14
		...
		Esri: {
			...
			variants: {
				...
				WorldTopoMap: {
					...
					options: {
                                                name: 'Topographical 1',
						attribution: '{attribution.Esri} &mdash; Esri, DeLorme, NAVTEQ, TomTom, Intermap, iPC, USGS, FAO, NPS, NRCAN'
					}
				},
				WorldImagery: {
					...
					options: {
                                                name: 'Aerial',
						attribution: '{attribution.Esri} &mdash; Source: Esri, i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid'
					}
				},
				WorldTerrain: {
		...
		Nokia: {
			...
			variants: {
				normalDay: {
					url: '//{s}.maptile.lbs.ovi.com/maptiler/v2/maptile/newest/normal.day/{z}/{x}/{y}/256/png8?token={devID}&app_id={appID}'
				},
				normalGreyDay: {
					url: '//{s}.maptile.lbs.ovi.com/maptiler/v2/maptile/newest/normal.day.grey/{z}/{x}/{y}/256/png8?token={devID}&app_id={appID}'
				},
				satelliteNoLabelsDay: {
					url: '//{s}.maptile.lbs.ovi.com/maptiler/v2/maptile/newest/satellite.day/{z}/{x}/{y}/256/png8?token={devID}&app_id={appID}'
				},
				satelliteYesLabelsDay: {
					url: '//{s}.maptile.lbs.ovi.com/maptiler/v2/maptile/newest/hybrid.day/{z}/{x}/{y}/256/png8?token={devID}&app_id={appID}'
				},
				terrainDay: {
					url: '//{s}.maptile.lbs.ovi.com/maptiler/v2/maptile/newest/terrain.day/{z}/{x}/{y}/256/png8?token={devID}&app_id={appID}'
				}
			}
		}
	};
